...
?>
    ...
    <form class="add_itp">
        ...
        <input type="date" id="itp_start"><br><br>
        <select id="itp_duration">
            <option value="3 luni">3 luni</option>
            <option value="6 luni">6 luni</option>
            <option value="1 an">1 an</option>
        </select><br><br>
        <input type="button" value="add itp..." id="add_itp"><br><br>
    </form>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#add_itp").on("click", function() {
            let car_id = $("#car_id").val();
            let itp_start = $("#itp_start").val();
            let itp_duration = $("#itp_duration").val();
            
            if(!car_id || !itp_start || !itp_duration) {
